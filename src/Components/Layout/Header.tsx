...
function Header() {
  ...
  return (
    <header className="mainHeader relative w-full h-screen overflow-hidden">
      <video src={video} className="w-full h-full object-cover" aria-hidden="true" loop autoPlay muted></video>
